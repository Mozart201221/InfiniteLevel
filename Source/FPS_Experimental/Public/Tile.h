...
UCLASS()
class FPS_EXPERIMENTAL_API ATile : public AActor
{
	GENERATED_BODY()
...
private:
	...
	//TArray<FSpawnPosition> RandomSpawnPositions(int32 MinSpawn, int32 MaxSpawn, float Radius, float MinScale, float MaxScale); // убрать
	...
	void PlaceActor(TSubclassOf<AActor> ToSpawn, FSpawnPosition SpawnPosition); // Лучше использовать "const FSpawnPosition&"
