...
void AFirstPersonCharacter::BeginPlay()
{
	...
	InputComponent->BindAction("Fire", IE_Pressed, Gun/*Points to gun created in Begin method*/, &AGun::OnFire);
}
...
void AFirstPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Fire", IE_Pressed, Gun/*Points to gun created in Begin method*/, &AGun::OnFire);
	/* Bind fire event
